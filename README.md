...
Controls: Up/Down selects, Right expands a workspace, Left collapses it, Home/End jumps, a configured single-character workspace key switches directly, Return activates the selected workspace or window, and Escape closes the overlay.
